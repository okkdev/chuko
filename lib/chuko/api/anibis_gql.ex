defmodule Chuko.Api.AnibisGql do
  @moduledoc """
  Literal copy of the Tutti GraphQL API. Should combine them at some point.
  """
  ...
  @url_item "https://www.anibis.ch/de/vi/"
  @url_api "https://www.anibis.ch/api/v10/graphql"
